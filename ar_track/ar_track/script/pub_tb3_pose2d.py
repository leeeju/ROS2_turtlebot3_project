...
class TB3Pose2D(Node):
    ...
    def get_odom_(self, msg):
        ...
        if   (theta - self.prv_theta) >  radians(270): # 5.0: #  5.0(rad) =  286.479(deg)
            d_theta = (theta - self.prv_theta) - 2 * pi # 마커를 찾기위한 회전을 합니다             
    ...
    def get_pose(self, msg):
        ...
        q = ( msg.pose.pose.orientation.x,  # 마커의 x,y,z,w 의 값을 받아서 q에 담습니다
    ...
    def print_pose(self, msg): # 마커의 위치 정보를 프린트 합니다
